        ...
        <head>
            ...
            <style type="text/css"><![CDATA[
                * { margin: 0; padding: 0 }
                ...
                #left-panel { position: absolute; left: 0; top:140px; bottom: 0; width: 300px; overflow: auto; background: #dee4ea }
                ...
                #right-panel { position: absolute; right: 0; top:140px; bottom: 0; left: 301px; overflow: auto; background: white }
